...
pub static OSDI_INTERNAL_NODE_COUNTER: AtomicUsize = AtomicUsize::new(10_000_000);

pub fn alloc_internal_node() -> NodeIdentifier {
    NodeIdentifier::Anonymous(OSDI_INTERNAL_NODE_COUNTER.fetch_add(1, Ordering::Relaxed))
}
