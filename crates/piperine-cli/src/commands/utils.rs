...
/// interactive TOFU prompt. A project with no `[plugins]` entry and no
/// contributing dependency (D9) yields an inert host. Scripted (`python = "…"`) plugins load through the embedded-CPython
