...
use piperine_codegen::codegen::CodegenError;
use piperine_codegen::ir::IrProgram;
use piperine_codegen::ir_analog_to_device::ir_analog_to_device;
use crate::runtime::digital_lower::ir_digital_to_interp;
use crate::runtime::device::PhdlDevice;

/// Monotonic counter for allocating anonymous analog node identifiers.
static NODE_CTR: AtomicUsize = AtomicUsize::new(100_000);
/// Monotonic counter for allocating digital net indices.
...
fn eval_ir_const(e: &piperine_codegen::ir::IrExpr, env: &HashMap<String, f64>) -> Option<f64> {
