...
impl Bjt {
    ...
    pub fn with_substrate(&mut self, node: impl Into<Node>) -> &mut Self {
        self.substrate = Some(node.into());
        self
    }
    ...
    pub fn with_areac(&mut self, v: impl Into<Dynamic<Dimensionless>>) -> &mut Self {
        self.areac = Some(v.into());
        self
    }
    pub fn with_areab(&mut self, v: impl Into<Dynamic<Dimensionless>>) -> &mut Self {
        self.areab = Some(v.into());
        self
    }
    ...
    pub fn with_ic(
        &mut self,
        vbe: impl Into<Dynamic<Volt>>,
        vce: impl Into<Dynamic<Volt>>,
    ) -> &mut Self {
    ...
    pub fn substrate(&self) -> Option<&Node> {
...
impl SpiceComponent for Bjt {
    fn into_spice(&self) -> String {
        ...
        if let Some(a) = &self.areac {
            s.push_str(&format!(" AREAC={}", a));
        }
        if let Some(a) = &self.areab {
            s.push_str(&format!(" AREAB={}", a));
        }
