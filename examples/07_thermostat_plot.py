...
ax.plot(axis * 1000, vals, linewidth=1.5, color="#d62728", label="Temperature")
...
ax.axhline(20.0, color="green", linestyle=":", alpha=0.4, label="Ambient (20 °C)")
ax.fill_between(axis * 1000, 22, 25, alpha=0.08, color="orange")

ax.set_xlabel("Time (ms)", fontsize=12)
ax.set_ylabel("Temperature (°C)", fontsize=12)
ax.set_title("Bang-Bang Thermostat — Limit Cycle with Hysteresis", fontsize=14)
