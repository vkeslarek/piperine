...
pub struct CircuitBuilder {
    ...
    subcircuits: HashMap<String, Circuit>,
}
...
impl CircuitBuilder {
    ...
    pub fn subcircuit(&mut self, name: impl Into<String>, circuit: impl IntoCircuit) {
        let title = name.into();
        self.subcircuits
            .insert(title.clone(), circuit.into_circuit(title.clone()));
    }
...
pub fn circuit(title: impl Into<String>, builder: impl IntoCircuit) -> Circuit {
    builder.into_circuit(title)
}
