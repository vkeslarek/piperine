...
**265 passing** (current — added 2 CLI tests for `check` command, 1 for bundle fan-out, 1 for digital interpreter non-blocking behavior, and 3 for B.5 implicit widening).
...
| `tests/b5_tests.rs` | 3 | B.5 implicit widening logic |
| `crates/piperine-lang/src/runtime/digital.rs` | 1 | Digital interpreter assignment test |

Any drop below 265 means a regression.
