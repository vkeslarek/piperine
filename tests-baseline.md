...
**262 passing** (current — added 2 CLI tests for `check` command, 1 for bundle fan-out, and 1 for digital interpreter non-blocking behavior).
...
Any drop below 262 means a regression.
